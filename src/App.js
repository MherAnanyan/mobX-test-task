...
function App(props) {
    ...
    const onSubmit = e => {
        ...
        if (store.firstName && store.lastName) {
            ...
            setError({ firstName: !store.firstName, lastName: !store.lastName });
        }
    };
                ...
                <div className="form-container">
                    <div className="input-container">
                        <input
                            ...
                            onChange={onChange}
                        />
                        {error.firstName && <div className="error-text">Field is Required</div>}
                    </div>
                    <div className="input-container">
                        <input
                            type="text"
                            ...
                            onChange={onChange}
                        />
                        {error.lastName && <div className="error-text">Field is Required</div>}
                    </div>
